...
export default function StellarCardGallerySingle({ cards, onRandomize }: StellarCardGalleryProps) {
  return (
        ...
        {onRandomize && (
          <div className="absolute top-4 right-4 z-20 pointer-events-auto">
            <button
              type="button"
              onClick={onRandomize}
              className="px-4 py-2 rounded-full bg-white/10 text-white text-xs font-medium border border-white/30 shadow-md backdrop-blur hover:bg-white/20 transition-colors"
            >
              Randomize quests
            </button>
          </div>
